...
<div id="page">
    <div class="header">
        ...
        <nav class="transparent z-depth-0 audID blue" id="navAud"
             role="navigation">
                ...
                <div class="hide-on-med-and-down">
                    <div class="row aud_menu blue">
                        <div class="audID blue" id="audIDnav">
                          ...
                          print strtoupper(theme('links__menu-audience-identifier', ['links' => $menua])); ?>
                        </div>
        ...
        <nav class="transparent z-depth-0 priMenu blue lighten-2" id="navPrim"
             role="navigation">
            <div class="nav-wrapper">
                <div class="hide-on-med-and-down">
    ...
    <div class="main page">
        ...
        ?>
          <div class="<?php print $classes; ?>">
              ...
              <div class="row heroInfo">
                ...
                $qResult = db_query('SELECT name FROM taxonomy_term_data WHERE tid=:AoStid', [':AoStid' => $AoStid]);
      ...
      <?php } ?>
        <div class="row nextStep">
            ...
            <div class="col m12 center-align nextStepButtons">
                <a class="waves-effect waves-light btn-large orange white-text">APPLY
                    NOW</a>
                <a class="waves-effect waves-light btn-large orange white-text">REQUEST
                    INFO</a>
            </div>
        </div>
      ...
      <?php } ?>
            ...
            <div class="container">
                <div class="section">
                    <div class="col m8 s12 blue white-text">
                        <h4 class="band-title">learn to shape the world around
                            us</h4>
                    </div>
                </div>
                <br>
                <div class="section">
                    <p class="flow-text">
                        <strong>Whether it's joining the beams in a high-rise
                            building, repairing pipelines, or
                            analyzing damaged structures, welders perform a
                            critical task we rely on every
                            day. </strong></p>
                    <p class="flow-text">Austin Community College's Welding
                        Technology Program prepares you to work in a
                        variety of settings. Students receive hands-on training
                        in a variety of welding techniques,
                        including oxy/fuel, shielded metal arc, gas tungsten
                        arc, gas metal arc, and flux-core arc.
                        Tracks are offered in a pipe welding, inspection,
                        ultrahigh purity piping, metalsmithing,
                        coppersmithing, and art metals.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row noSideMargin">
            <div class="col m5 s12 blue white-text"><h4>skills you gain</h4>
            </div>
            <div class="col m6 s12 offset-m1 blue white-text"><h4>possible job
                    titles</h4></div>
        </div>
        <div class="row smallContainer">
            <div class="row">
                <div class="col m5 s12">
                    <br/>
                    <p>
                        Students build expertise in blueprint interpretation,
                        layout and fabrication, plate and pipe
                        welding,
                        ultrasonic testing, and welding inspection (including
                        preparation for the Certified Welding
                        Inspector
                        Exam).
                    </p>
                    <br/>
                    <p>
                        Graduates are employed in a wide range of organizations
                        in fields such as construction,
                        engineering,
                        infrastructure, semiconductor, metallurgy, oil and gas,
                        and industrial inspection, not to
                        mention local
                ...
                <ul class="col m6 s12 offset-m1">
                  <?php
                  $record = ['47-1011.00', '47-2152.01', '47-2171.00'];
                  if (!empty($record)){
                  $loopCount = 0;
                  ...
                  if ($loopCount === 0){ ?>
                                      ...
                                      ?>
                                        <div class="jobRise">
                                            <div class="col m4 offset-m2 JRText">
                                                <b>
                                                  <?php echo $employed ?></b>
                                              <?php echo $json['data'][0]['attributes']['title'] ?>
                                                are employed. This
                                                number is expected to
                                              <?php echo $updown ?> <b>
                                                <?php echo $changePer ?>%</b>
                    ...
                    <input type="hidden" id="myLoopValue"
                           value="<?php echo $loopCount ?>"/>
                    <input type="hidden" id="myOnetCodes"
                           value="<?php echo implode(",", $final_codes); ?>"/>
            </div>
        </div>
      <?php
      $entityPush = entity_load('field_collection_item', [$node->field_testimonial_info[LANGUAGE_NONE][0]['value']]);
      ...
      ?>
        <div class="row testimonial noSideMargin">
            ...
            <div class="valign-wrapper col m7 AoStestText"
                ...
                <div class="row testContent noSideMargin">
                    ...
                    <div class="col m11">
                        <h4 class="valign center-align"><?php print $testText ?>
                            "</h4>
                    </div>
                    <div class="col m12">
        ...
        <div class="row awardsPath">
            <div class="col m6">
                <div class="col m12 blue white-text"><h4>available awards</h4>
                </div>
                ...
                <div class="col m12">
                    ...
                    <ul>
                        <li><a href="#">Welding Tech- Art Metals: Blacksmithing
                                Specialization (Associate of Applied
                                Science)</a></li>
                        <li><a href="#">Welding Tech- Art Metals: Metal
                                Sculpture Specialization (Associate of Applied
                                Science)</a></li>
                    </ul>
                </div>
                <br/>
                ...
                <div class="col m12">
                    ...
                    <ul>
                        <li><a href="#">Art Metals: Blacksmithing Welding
                                Technology (Certificate Level 1)</a></li>
                        <li><a href="#">Inspection Welding Technology
                                (Certificate Level 1)</a></li>
                        <li><a href="#">Metal Sculpture Welding Technology
                                (Certificate Level 1)</a></li>
                        <li><a href="#">Pipe Welding Welding Technology
                                (Certificate Level 1)</a></li>
                        <li><a href="#">Structural Welding Welding Technology
                                (Certificate Level 1)</a></li>
                    </ul>
                </div>
            </div>
            <div class="col m5 offset-m1 valign-wrapper blue white-text">
                <div class="valign bgQuestion" data-bg-question="?">
                    ...
                    <p> ACC offers a variety of degree and certificate options
                        to get you ready for the next step in
                        your
                        academic and career journey. Choosing the right award
                        path is an important first step to reach
                        your
  ...
  <?php
  $entityLoad = entity_load('field_collection_item', [$node->field_department_contact[LANGUAGE_NONE][0]['value']]);
  ...
  ?>
                ...
                <div class="section">
                    <div class="row contactHead">
                        ...
                        <div class="col m4  valign-wrapper lightgreen blue-text">
                            <h6 class="valign right-align">CONTACT
                                INFORMATION</h6>
                        </div>
                    </div>
                    <div class="row contactBody">
                        <div class="col m5 borderRight">
                            <div class="row">
                                <div class="col m12">
                                    <h6 class="valign purple-text">MAIN
                                        CONTACT: <?php if (isset($mainC)) {
                            ...
                            <div class="row thin">
                                ...
                                <div class="col m10">
                                    <h6 class="valign"><a
                                                href="mailto:<?php if (isset($mainE)) {
                                                  print $mainE;
                                                } ?>"><?php if (isset($mainE)) {
                                          print $mainE;
                                        } ?></a></h6>
                        ...
                        <div class="col m7">
                            <div class="col m12">
                                <h6 class="valign purple-text">
                                    CHAIR: <?php if (isset($chairC)) {
                            ...
                            <div class="col m12">
                                <h6 class="valign"><a
                                            href="mailto:<?php if (isset($chairE)) {
                                              print $chairE;
                                            } ?>"><?php if (isset($chairE)) {
                                      print $chairE;
                                    } ?></a></h6>
    ...
    <div class="footer">
        ...
        <nav class="transparent z-depth-0 audID2 bluegrey" id="navFoot"
             role="navigation">
            ...
            <div class="searchContainer" id="searchFoot">
                <form class="searchbox-foot">
                    <input type="search" placeholder="Search......"
                           name="search" class="searchbox-input-foot"
                           onkeyup="buttonUp();" required>
