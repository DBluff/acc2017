...
<div id="page">
    ...
    <div class="main page">
                ...
                <div class="section">
                    <p class="flow-text">
                        <strong>Whether it's joining the beams in a high-rise building, repairing pipelines, or
                            ...
                            day. </strong></p>
                    <p class="flow-text">Austin Community College's Welding Technology Program prepares you to work on a
                        variety of settings. Students receive hands-on training in a variety of welding techniques,
                        including oxy/fuel, shielded metal arc, gas tungsten arc, gas metal arc, and flux-core arc.
                        Tracks are offered in a pipe welding, inspection, ultrahigh purity piping, metalsmithing,
                                    ...
                                    <div id="jobInfo<?php echo $loopCount ?>">
                                        ...
                                        <div class="jobRise">
                                            <div class="col m4 offset-m2 JRText">
                                                <b>
                                                    <?php echo $employed ?></b>
                                                <?php echo $json['data']['attributes']['title'] ?> are employed. This
                                                number is
                                                expected to
                                                <?php echo $updown ?> <b>
        ...
        foreach ($entityPush as $entities) {
            if (isset($entities->field_testimonial_hero[LANGUAGE_NONE][0]['value'])) {
        ...
        <div class="row testimonial">
            <div class="col m5 AoStestImg">
                <img class="responsive-img" src="<?php print $testImg ?>">
            </div>
        ...
        <div class="row awardsPath">
            <div class="col m6">
                ...
                <div class="col m12">
                    ...
                    <ul>
                        <li><a href="#">Welding Tech- Art Metals: Blacksmithing Specialization (Associate of Applied Science)</a></li>
                        <li><a href="#">Welding Tech- Art Metals: Metal Sculpture Specialization (Associate of Applied Science)</a></li>
                    </ul>
                </div>
                <br />
                <br />
                ...
                <div class="row outerBorder">
                    <div class="section">
                        <div class="row contactHead">
                            <div class="col m8 valign-wrapper">
                                <h6 class="valign blue-text">AREA OF STUDY PROGRAM: <?php print strtoupper(drupal_get_title()) ?></h6>
                            </div>
                        ...
                        <div class="row contactBody">
                            <div class="col m5 borderRight">
                                <div class="row">
                                    <div class="col m12">
                                        <h6 class="valign purple-text">MAIN CONTACT: <?php if (isset($mainC)){print strtoupper($mainC);} ?></h6>
                                    </div>
                                </div>
                                <div class="row thin">
                                    ...
                                    <div class="col m10">
                                        <h6 class="valign"><?php if (isset($mainA)){print $mainA;} ?></h6>
                                    </div>
                                </div>
                                <div class="row thin">
                                    <div class="col m10 offset-m2">
                                        <h6 class="valign"><?php if (isset($mainS)){print $mainS;} ?></h6>
                                    </div>
                                </div>
                                <div class="row thin">
                                    <div class="col m2 lightgreen-text">
                                    ...
                                    <div class="col m10">
                                        <h6 class="valign"><a href="tel:<?php if (isset($mainP)){print $mainP;} ?>"><?php if (isset($mainP)){print $mainP;} ?></a></h6>
                                    </div>
                                </div>
                                <div class="row thin">
                                    <div class="col m2 lightgreen-text">
                                    ...
                                    <div class="col m10">
                                        <h6 class="valign"><a href="mailto:<?php if (isset($mainE)){print $mainE;} ?>"><?php if (isset($mainE)){print $mainE;} ?></a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col m7">
                                <div class="col m12">
                                    <h6 class="valign purple-text">CHAIR: <?php if (isset($chairC)){print strtoupper($chairC);} ?></h6>
                                </div>
                                <div class="col m12">
                                    <h6 class="valign"><?php if (isset($chairA)){print $chairA;} ?></h6>
                                </div>
                                <div class="col m12">
                                    <h6 class="valign"><?php if (isset($chairS)){print $chairS;} ?></h6>
                                </div>
                                <div class="col m12">
                                    <h6 class="valign"><a href="tel:<?php if (isset($chairP)){print $chairP;} ?>"><?php if (isset($chairP)){print $chairP;} ?></a></h6>
                                </div>
                                <div class="col m12">
                                    <h6 class="valign"><a href="mailto:<?php if (isset($chairE)){print $chairE;} ?>"><?php if (isset($chairE)){print $chairE;} ?></a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
